...
//useConstantMethod(1);  //useConstantMethod(2);
//useConstantMethod(3);  //useConstantMethod(4);
//useConstantMethod(100); //useConstantMethod(5); 5 olmamasına rağmen yazmaya izin verir çalışınca hata alırız
useEnumMethod(TransactionType.DEPOSIT);
useEnumMethod(TransactionType.PAYMENT);
useEnumMethod(TransactionType.WITHDRAW);
useEnumMethod(TransactionType.OTHER);//useEnumMethod(TransactionType.a); enum dışında yazmamıza izin vermez
    }
    //eski tarz****************************************************************
