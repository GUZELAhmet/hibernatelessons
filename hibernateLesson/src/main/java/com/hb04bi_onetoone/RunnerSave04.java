...
public class RunnerSave04 {
    ...
    public static void main(String[] args) {
        ...
        // student3.setDiary(diary);   ilişki burada olalamaz setlemeye çalışsakta null değeri alırız


        Diary04 diary1= new Diary04();
        diary1.setId(101);
        diary1.setName("A diary");
        diary1.setStudent(student1); // ilişkş sahibi diary olduğu için setStudent methodu burada kullanılır
